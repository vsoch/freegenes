...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'fg.apps.base.context_processors.auth_processor',
                'fg.apps.base.context_processors.domain_processor',
                'fg.apps.base.context_processors.help_processor' # custom context processors
            ],
        },
    },
]
